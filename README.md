...
从图像分类与线性模型出发，逐步理解神经网络、反向传播、优化方法和卷积神经网络。
...
[![Status](https://img.shields.io/badge/Status-持续更新-blue?style=for-the-badge)](#更新计划)
...
这条路线从“图像如何被计算机表示”开始，先建立分类问题的基本框架，再逐步进入可学习模型、梯度优化与深度卷积网络。
